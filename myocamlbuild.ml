(* OASIS_START *)
(* DO NOT EDIT (digest: ac972463162ef0c3e375c35394771628) *)
...
let package_default =
  {
     ...
     includes =
       [
          ("src/server", ["src/game"; "src/utils"]);
          ("src/model", ["src/utils"]);
          ("src/main", ["src/game"; "src/model"; "src/server"; "src/utils"]);
          ("src/game", ["src/model"; "src/utils"])
       ];
     }
  ;;
