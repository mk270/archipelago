...
(* OASIS_START *)
(* DO NOT EDIT (digest: e5814b300a90c1f3400e83f59827e113) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "utils"; InternalLibrary "model"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "?\129\209\021-\185\206V\197\189+\156\171\219\164'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
